...
class CustomerDashboard:
    ...
    def Create_top_frame(self):
        ...
        date_label = tk.Label(top_frame, text=date_str, font=("Arial", 18, "bold"), bg="#96EFFF", width=15, fg="black")
    ...
    def Create_left_frame(self):
        ...
        booking_button = tk.Button(left_frame, text="Make Booking", bg="#AFC8AD", width=16, fg="black",
                                   font=("Arila", 15, "bold"))
        ...
        logout_button = tk.Button(left_frame, text="LogOut", bg="#AFC8AD", width=13, fg="black",
                                  font=("Arila", 15, "bold"), command=self.Action_Logout)
        logout_button.place(x=60, y=420)

    def Create_center_frame(self):
        left_frame = tk.Frame(self.root, bg="#FFEEF4", width=1000, height=800)
        left_frame.place(x=310, y=110)

    def Action_Logout(self):
        self.root.destroy()
        from Frontend.LoginGui import LoginPage
        root = tk.Tk()
        LoginPage(root)
